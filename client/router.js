...
const PostsCreate = () => import('~/pages/posts/create').then(m => m.default || m)
...
const routes = [
    ...
    },
    {
        ...
        component: Posts,
        children: [
            {path: 'index', name: 'posts.index', component: Posts},
            {path: 'create', name: 'posts.create', component: PostsCreate},
        ]
    }
]
